...
This guide walks through testing the entire Web Search Skill integration with BizOwl.

## Prerequisites

1. BizOwl built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with BizOwl.

**Steps:**

1. Start BizOwl in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of BizOwl launch.
...
1. Open a terminal while BizOwl is running
...
**Objective:** Verify graceful shutdown of services when BizOwl quits.

**Steps:**

1. With BizOwl running and searches completed, quit the application
...
1. Start BizOwl (ensure headless is false in config)
...
- ✅ Server auto-starts with BizOwl
