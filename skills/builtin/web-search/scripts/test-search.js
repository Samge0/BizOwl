...
async function testSearchIntegration() {
  ...
  try {
    ...
    const launchResponse = await fetch('http://127.0.0.1:37823/api/browser/launch', {
      method: 'POST',
    ...
    const connectResponse = await fetch('http://127.0.0.1:37823/api/browser/connect', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({})
    });
    ...
    const searchResponse = await fetch('http://127.0.0.1:37823/api/search', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        connectionId,
    ...
    const screenshotResponse = await fetch('http://127.0.0.1:37823/api/page/screenshot', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        connectionId,
    ...
    const textResponse = await fetch('http://127.0.0.1:37823/api/page/text', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    const statusResponse = await fetch('http://127.0.0.1:37823/api/browser/status');
    ...
    if (connectionId) {
      try {
        await fetch('http://127.0.0.1:37823/api/browser/disconnect', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ connectionId })
        });
