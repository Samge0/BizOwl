---
name: local-tools
description: 访问本机系统资源，包括 macOS 和 Windows 的日历能力。当需要直接在用户设备上查看、创建或管理日程时使用。
official: true
---
...
# "Calendar access permission is required. Please open System Settings > Privacy & Security > Calendar, and authorize Terminal or BizOwl"
```
...
```
**Solution:** Open System Settings > Privacy & Security > Calendar, authorize Terminal or BizOwl
