...
Use existing resolvable packages first. Install `react-icons`, `react`, `react-dom`, or `sharp` only if they are actually missing and the slide design needs icon rasterization.
